            ...
            <div id="register">
                ...
                <div>
                    <form action="controller/register.php" method="post">
                        ...
                        <label>Date de naissance<input type="date" class="form-control" name="birthDate" id="birthDate" placeholder="Date de naissance" required="required"></label>
                        <label><input type="number" class="form-control" name="phoneNumber" id="phoneNumber" placeholder="Numéro de téléphone" required="required"></label>
